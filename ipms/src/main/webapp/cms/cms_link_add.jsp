...
<body>
	<div class="uk-panel uk-panel-box">
		<ul class="uk-breadcrumb">
			...
			<li>其他管理</li>
			<li class="uk-active">新增链接</li>
		</ul>
		<hr>
		<form class="uk-form uk-form-stacked myform" name="myform" method="post" enctype="multipart/form-data">
			<div class="uk-grid">
				<!-- 左边 -->
				<div class="uk-width-1-4" style="width:155px">
					<div class="uk-position-relative">
						<img width="120px" height="120px" id="preview" src="<%=request.getContextPath()%>/img/placeholder_600x400.svg" />
					</div>
				...
				<div class="uk-width-2-4">
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="10" name="linkname" placeholder="标题" required />
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" name="linkUrl" size="50" placeholder="链接" required />
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label" for="">排序<span style="color:red"> *</span></label>
						<div class="uk-form-controls">
							<input type="text" name="orderby" size="20" placeholder="排序" required />
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label" for="">备注</label>
						<div class="uk-form-controls">
							<textarea rows="3" cols="67" name="remark" style="resize: none" ></textarea>
						</div>
					</div>
					
					<div class="uk-form-row">
						<button class="uk-button uk-button-success" type="submit">添加</button>
					</div>
				</div>
				<!-- 右边说明 -->
	...
	$(function(){
		$('.myform').validate({
			...
			submitHandler:function(){
				document.myform.action = "<%=request.getContextPath()%>/cms_link/addLink.do";
