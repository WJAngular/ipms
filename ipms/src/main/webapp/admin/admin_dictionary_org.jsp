...
<body class="uk-height-1-1">
	<div class="uk-panel uk-panel-box">
		<ul class="uk-breadcrumb">
			...
			<li>用户管理</li>
			<li class="uk-active">组织管理</li>
		</ul>
		<hr>
		<div class="uk-margin-bottom uk-clearfix">
			<div class="uk-float-left">
				<a href="<%=request.getContextPath()%>/admin/admin_dictionary_org_Add.jsp" class="uk-button uk-button-success">新增</a>
			</div>
			<form class="uk-form uk-float-right" name="myform" method="post" action="<%=request.getContextPath()%>/sysdictionary/getOrganizationList.do">
...
<script>
	function del(id) {
		...
		$.get("<%=request.getContextPath()%>/sysdictionary/delOrganization.do?id=" + id, function(data) {
	...
	function edit(id) {
		window.location.href = "<%=request.getContextPath()%>/sysdictionary/getOrganization.do?id=" + id;
	}
</script>
</html>