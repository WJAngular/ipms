...
<body class="uk-height-1-1">
	<div class="uk-panel uk-panel-box">
		...
		<form class="uk-form uk-form-horizontal myform" name="myform" method="post">
			...
			<input type="hidden" name="ocode" value="${dict.ocode }">
			<div class="uk-grid">
				...
				<div class="uk-width-1-1 uk-margin-top">
					<button class="uk-button uk-button-success uk-width-1-1" onclick="upddict()">确认</button>
				</div>
			</div>
		</form>
	</div>
	...
	$(function(){
		$('.myform').validate({
			...
			submitHandler:function(){
				document.myform.action = "<%=request.getContextPath()%>/sysdictionary/updOrganization.do";
