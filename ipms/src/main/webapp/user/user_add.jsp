			...
			<div class="uk-grid uk-grid-divider">
				<div class="uk-width-1-2">
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="30" name="name" placeholder="您的名称">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">曾用名</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="formerName" placeholder="曾用名">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">性别</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="sex"  placeholder="性别自动根据身份证获取">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">民族</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="nation" id="nation">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">籍贯</label>
						<div class="uk-form-controls">
							<input type="text" name="natives">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">出生地</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="placeOfBirth">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">户口所在地址</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="registeredResidence">
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="30" name="idCard" id="idCard" placeholder="身份证号">
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="30" name="postEdcation">
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="dateOfParticipatingInWork" placeholder="YYYY-MM-DD"  readonly/>
							</div>
						</div>
					</div>
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="30" name="job">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">联系电话</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="otherTel">
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="30" name="workingLocation">
						</div>
					</div>
					<div class="uk-form-row">
						<label class="uk-form-label">所属行业</label>
						<div class="uk-form-controls">
							<input type="text" size="30" name="industry">
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<input type="text" size="30" name="rmk">
						</div>
					</div>
				</div>
				<!-- 右边 -->
				<div class="uk-width-1-2">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon uk-form-icon-flip">
								<input type="text" name="originalPartyOrg">
							</div>
						</div>
					</div>
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="turnInDate" placeholder="YYYY-MM-DD"   />
							</div>
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="inDate" placeholder="YYYY-MM-DD"  required  />
							</div>
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="duesvaliddate" placeholder="YYYY-MM-DD"    />
							</div>
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon uk-form-icon-flip">
								<input type="text" name="partyIntroducer">
							</div>
						</div>
					</div>
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="qualifiedDate" placeholder="YYYY-MM-DD"   />
							</div>
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="retiredDate" placeholder="YYYY-MM-DD"   readonly/>
							</div>
						</div>
					</div>
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon">
								<i class="uk-icon-calendar"></i><input type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="leaveDate" placeholder="YYYY-MM-DD"   readonly/>
							</div>
						</div>
					</div>
					<div class="uk-form-row">
					...
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon uk-form-icon-flip">
								<input type="text" name="branchSecretary">
							</div>
						</div>
					</div>
					<div class="uk-form-row">
						...
						<div class="uk-form-controls">
							<div class="uk-form-icon uk-form-icon-flip">
								<input type="text" name="branchSecretaryTel">
							</div>
						</div>
					</div>
					<div class="uk-form-row">
	...
	$(function(){
		$('.myform').validate({
			...
			submitHandler:function(){
				document.myform.action = "<%=request.getContextPath()%>/user/addUser.do";
