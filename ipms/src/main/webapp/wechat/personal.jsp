...
<body>
	...
	<div class="row personInfo">
		<div class="col col-33">
				<img src="${imgPath }" width="80" style="border-radius:80px;"/>
			</div> 
		<div class="col" style="line-height: 40px; border-left: none;">
			<h4>${user.name}</h4>
			<p class="birth">
				出生日期：
	...
	<div class="list infomate">
		<div class="row">
			<div class="col personlist col-33">
				<strong>性别</strong>
			</div>
		...
		<div class="row" ng-show="true">
			<div class="col personlist col-40">
				<strong>支部书记电话</strong>
			</div>
			<div class="col personlist col-60">${user.branchSecretaryTel}</div>
		</div>
	</div>
	</ion-content>
</body>
