...
import com.wechat.api.*;
import com.wechat.bean.Articles;
import com.wechat.bean.Attachment;
import com.wechat.bean.InMessage;
import com.wechat.bean.OutMessage;
import com.wechat.inf.MessageProcessingHandler;
...
//    public static final Oauth oauth = new Oauth();
     ...
     * @author justbamboo
     * @throws Exception 
     * @date 2015年11月11日 下午3:55:19
     */
//    public static String getUserOpenId(String code) throws Exception{
...
//    
     ...
     * 根据接收到用户消息进行处�?
     *
     * @param responseInputString 微信发�?�过来的xml消息�?
     * @return
     */
